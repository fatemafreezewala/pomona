...
const TitleDesp = ({route,navigation}) => { 
  ...
  return (
    <View style={[globalStyle.container,globalStyle.dullBackground]}>
     ...
     <CTextInput onChange={setTitle} placeholder='Enter template title' ></CTextInput>
     <TextInput onChangeText={setDesp} textAlignVertical='top' style={{
      ...
      }} multiline placeholderTextColor="#000" numberOfLines={5} placeholder='Enter description or personel note'></TextInput>
      <Text style={[{fontSize:15,color:colors.black,fontFamily:fontFamily.Medium},globalStyle.mt5]}>Choose a color for your template</Text>
      <View style={{justifyContent:'space-between',flexDirection:'row',marginTop:10}}>
      <FlatList
      horizontal
        data={[{color:'#F4A060'},{color:'#E4E1D7'},{color:'#DFD2BF'},{color:'#E08A63'},{color:'#A6AD5F'}]}
