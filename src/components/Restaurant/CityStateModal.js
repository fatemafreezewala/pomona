...
const AllCourses = ({data,modalVisible, setModalVisible,onSelect}) => {
    ...
    return  (
        ...
        <View style={styles.maincontainer}>
          ...
          <FA name='close' size={30} style={{alignSelf:'flex-end',padding:5}}></FA>
          </TouchableOpacity>
        <Searchbar
          ...
          showsVerticalScrollIndicator={false}
              ...
              renderItem={({item})=>(
                  ...
                  <TouchableOpacity onPress={()=>{
                      ...
                      <Text style={{color:colors.black,fontFamily:fontFamily.Regular}}>{item.name}</Text>
                  </TouchableOpacity>
                </>
              )}
