...
const list = item.user_template_items.split(',')
  return (
    <TouchableOpacity key={item.user_template_id} onPress={onPress} style={[{backgroundColor:item.user_allergy_temp_color == '' ? '#fff' : item.user_allergy_temp_color,padding:8,width:'50%',borderWidth:5,
    borderColor:'#e6eae1',borderRadius:15,flexDirection:'column'},globalStyle.mt5]}>
