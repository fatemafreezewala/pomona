...
const AddItem = ({modalVisible,setModalVisible,onAddItem,setItemName}) => {
  return (
        ...
        <View style={styles.centeredView}>
         ...
         <View style={styles.modalView}>
          ...
          setModalVisible(false);
           ...
           <Text style={{fontFamily:fontFamily.Medium,color:colors.black,fontSize:15,marginVertical:15}}>Name of the item</Text>
            <FTextInput  onChange={setItemName} placeholder="Enter Name"></FTextInput>
